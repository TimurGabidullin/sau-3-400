        ...
        <Fade bottom cascade>
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                ...
                <p> Измерьте с помощью вольметра ИП&#8544; пульта ППН-149 значение напряжения постоянного тока между
                    контактам 22 и 11 контрольного соединителя Ш35 блока ВБК-51-01 во всех каналах САУ.</p>
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                <p> Измерьте с помощью вольметра ИП&#8544; пульта ППН-149 значение напряжения постоянного тока между
                    контактам 24 и 11 контрольного соединителя Ш35 блока ВБК-51-01 во всех каналах САУ.</p>
                <p> Значение напряжения должно быть не более ±0,1В.</p>
            </Typography>
