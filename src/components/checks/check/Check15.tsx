    ...
    return (
        <Fade bottom cascade>
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                ...
                <p> Вкдючите канал САУ, для чего на пульте ПС-172-02 нажмите кнопку-лампочку КРЕН &#8544;; включите
                ...
                <p> Ручкой КУРС на пульте ПУ-165-01 совместите индекс ЗК на ПНП левого летчика с индексом отсчета
                    текущего курса</p>
                <p> Измерьте с помощью пульта ППН-149 значение напряжения постоянного тока между контактам 24 и 11
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                <p> Поворачивая ручку КУРС на пульте ПУ-165-01, отклоните индексы ЗК на обоих ПНП на угол 1-3°
                    ...
                    стрелке.</p>
                <p> Поворачивая ручку КУРС, отклоните индексы ЗК на обоих ПНП на угол (10±1)° по шкале текущего
                    курса
                    вправо.</p>
                <p> Измерьте с помощью пульта ППН-149 значение напряжения постоянного тока между контактам 24 и 11
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                ...
                <p>Измерьте с помощью пульта ППН-149 значение напряжения постоянного тока между контактам 25 и 11
                    контрольного соединителя Ш35 блока ВБК-51-01 во всех каналах САУ, оно должно быть минус
                    5,7-5,9В.</p>
            </Typography>
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                <p>Поворачивая ручку КУРС на ПУ-165-01 против часовой стрелки, установите индексы ЗК на
                    ПНП<span>лев</span>,
                    ПНП<span>прав</span> на отметку 270°.</p>
                <p>Измерьте с помощью пульта ППН-149 значение напряжения постоянного тока между контактам 25 и 11
                    контрольного соединителя Ш35 блока ВБК-51-01 во всех каналах САУ, оно должно быть минус
                    5,7-5,9В.</p>
            </Typography>
