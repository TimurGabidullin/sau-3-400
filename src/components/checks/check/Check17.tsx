        ...
        <Fade bottom cascade>
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                <p> Измерьте с помощью пульта ППН-149 значение напряжения постоянного тока
                    U<span>22</span>&#8544;(&#8546;),
                    U<span>22</span>&#8545;(&#8547;) между контактам 22 и 11 контрольного соединителя Ш35 блока
                    ВБК-51-01
                    в &#8545;(&#8547;) и &#8545;(&#8547;) каналах.</p>
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                ...
                и "7".</p>
                <p> Измерьте с помощью универсального вольметра и пульта ППН-149 значение напряжения постоянного тока
                    U<span>5-6</span> между контактам 5 и 6 контрольного соединителя Ш35 блока ВБК-51-01 каналов
            ...
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                <p> Измерьте с помощью пульта ППН-149 значение напряжения постоянного тока
                    U<span>22</span> между контактам 22 и 11 контрольного соединителя Ш35 блока
