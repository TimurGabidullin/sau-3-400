    ...
    return (
        <Fade bottom cascade>
            <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                <p>  ВНИМАНИЕ!!! ЦЕНТРОВКУ ВЫЧИСЛИТЕЛЕЙ И УСИЛИТЕЛЕЙ СЕРВОПРИВОДА КАНАЛА КУРС ПРОИЗВОДИТЕ ТОЛЬКО ПО ЗАМЕЧАНИЯМ
                ЭКИПАЖА, А ТАКЖЕ ПРИ ЗАМЕНЕ ВЫЧИСЛИТЕЛЯ ВБК-51-01 (СУББЛОКОВ ВН-77, УС27-3), ДАТЧИКОВ ДГУ.</p>
                <p> На датчиках поперечной перегрузки ДГУ установите ручки арретиров в положение ВКЛ.</p>
                <p> На пульте ПК-31-01 переключатель ИСКЛЮЧ ПОСАДКА установите в положение Eк, ИСКЛЮЧ УСП - в
                    положение "4".</p>
                <p> Отключите АЗК САУ ЛЕВ на ЦРУ 200/115В ЛЕВОЕ и АЗК САУ ПРАВ на ЦРУ 200/115В ПРАВОЕ.</p>
