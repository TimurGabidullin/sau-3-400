        ...
        <Fade bottom cascade>
            <div className={styles.checkContainer}>
                ...
                <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                    ...
                    <p> Плавно вращая ручки датчиков ТАНГАЖ на имитаторах ИМБ-5 по (против) часовой стрелке и не
                        допуская
                    ...
                    <p> Измерьте с помощью пульта ППН-149 значение напряжения
                        U<span>Vк(п)</span>&#8544;(&#8545;,&#8546;,&#8547;) между
                        контактами 26 и 11 контрольного соединителя Ш35 на блоках ВПК-52-01
                        в &#8544;, &#8545;, &#8546; каналах САУ.</p>
                ...
                <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                    <p> Измерьте с помощью пульта ППН-149 значение напряжения остоянного тока
                        U<span>&#x394;Vк(п)</span>&#8544;(&#8545;,&#8546;,&#8547;)
                        между контактами 20 и 11 контрольного соединителя Ш35 ВПК-52-01
                        во всех каналах САУ.</p>
                    <p> Проверьте, что:</p>
                    <p>(U<span>&#x394;Vк(п)</span>&#8544;-U<span>&#x394;V0</span>&#8544;)/V<span>к(п)</span>&#8544;=-(0,5±0,05)В/°,
                    </p>
                    <p>(U<span>&#x394;Vк(п)</span>&#8545;-U<span>&#x394;V0</span>&#8545;)/V<span>к(п)</span>&#8545;=-(0,5±0,05)В/°,
                    </p>
                    <p>(U<span>&#x394;Vк(п)</span>&#8546;-U<span>&#x394;V0</span>&#8546;)/V<span>к(п)</span>&#8546;=-(0,5±0,05)В/°,
                    </p>
                    <p>(U<span>&#x394;Vк(п)</span>&#8547;-U<span>&#x394;V0</span>&#8547;)/V<span>к(п)</span>&#8547;=-(0,5±0,05)В/°.
                    </p>
                </Typography>
                ...
                <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                    ...
                    <p>Измерьте с помощью пульта ППН-149 значения напряжений
                        U<span>&#611;п(л)</span>&#8544;(&#8545;,&#8546;)
                        между контактами 26 и 11 соединителя Ш35 на блоках ВБК-51-01.
                        на &#8544;, &#8545; и &#8546; каналах.
                ...
                <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                    <p>Плавно вращая ручки датчиков &#936;<span>гмк</span> имитаторов ИМБ-5 по (против) часовой стрелке
                        и не допуская
                        расхождения между ними более, чем на 1°, установите значение угла курса:</p>
                    <p>&#936;<span>п(л)</span>&#8544;(&#8545;,&#8546;)=(7±0,05)° вправо (влево).</p>

                    <p>Измерьте с помощью пульта ППН-149 значение напряжений
                        U<span>&#x394;&#936;п(л)</span>&#8544;(&#8545;,&#8546;,&#8547;)
                        между контактам 24 и 11 контрольного соединителя Ш35 ВБК-51-01 во всех каналах САУ.
                        Проверьте , что</p>
                    <p>(U<span>&#x394;&#936;п(л)</span>&#8544;-U<span>&#x394;&#x3A8;0</span>&#8544;/&#936;
                        <span>к(п)</span>&#8544;=-(0,32±0,03)В/°</p>
                    <p>(U<span>&#x394;&#936;п(л)</span>&#8545;-U<span>&#x394;&#x3A8;0</span>&#8545;/&#936;
                        <span>к(п)</span>&#8545;=-(0,32±0,03)В/°</p>
                    <p>(U<span>&#x394;&#936;п(л)</span>&#8546;-U<span>&#x394;&#x3A8;0</span>&#8546;/&#936;
                        <span>к(п)</span>&#8546;=-(0,32±0,03)В/°</p>
                    <p>(U<span>&#x394;&#936;п(л)</span>&#8547;-U<span>&#x394;&#x3A8;0</span>&#8547;/&#936;
                        <span>к(п)</span>&#8547;=-(0,32±0,03)В/°</p>
                </Typography>
                ...
                <Typography sx={{padding: '0 20px'}} variant="body1" component='p'>
                    <p>Плавно вращая ручки датчиков &#936;<span>гмк</span> имитаторов ИМБ-5 и не допуская расхождения
                        между
